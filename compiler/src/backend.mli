...
module Vernac :
  sig    
    ...
    val define_inductive_scheme : (Names.Id.t * Names.Id.t * Sorts.family) list -> unit t
    val define_term : ?ty:Constrexpr.constr_expr -> name:Names.Id.t -> Constrexpr.constr_expr -> unit t
    val open_module :
    ...
    val construct_term_using_proof :
      ...
      ty:Constrexpr.constr_expr -> unit -> unit t
  end
