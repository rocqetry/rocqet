...
family Base.FrontendLanguage.Semantics {
        Inductive cont : Type :=
           | Kstop : cont
        ...
        Inductive step : state -> trace -> state -> Prop :=
             | step_assign : forall st i a k n,            
                 ...
                 step (State (Sassign i a) k st)
                   E0 (State Sskip k (t_update st i n))             
...
family Base.SourceLanguage extends FrontendLanguage { 
...
family Base.MinorLanguage extends FrontendLanguage {
