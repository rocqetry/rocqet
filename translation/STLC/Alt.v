...
Module STLCBase_Ty (self : STLCBase_Ty_Ctx).
  Axiom Ty : Set.
End STLCBase_Ty.

Module Type STLCBase_Ty_Ctrs_Ctx.
  Include STLCBase_Ty_Ctx.
  Include STLCBase_Ty.
End STLCBase_Ty_Ctrs_Ctx.

Module Type STLCBase_Ty_Ctrs (self : STLCBase_Ty_Ctrs_Ctx). 
  Axiom TyUnit : self.Ty.
  Axiom TNat : self.Ty. 
  Axiom TArr : self.Ty -> self.Ty -> self.Ty.
End STLCBase_Ty_Ctrs.
...
Module STLC_.
  Inductive Ty : Set := 
    | STLCBase : STLCBase.Ty -> Ty
    | TBool.
  
  Definition TyUnit := STLCBase STLCBase.TyUnit.
...
Module Type STLCIf_Ty_Ctrs_Ctx.
  Include STLCIf_Ty_Ctx.
  Include STLCIf_Ty.
End STLCIf_Ty_Ctrs_Ctx.

Module Type STLCIf_Ty_Ctrs (self : STLCIf_Ty_Ctrs_Ctx).   
  Axiom TBool : self.Ty.
End STLCIf_Ty_Ctrs.

(* Include STLCBase_Ty_Ctrs (self).*)
...
Module Type BaseComp_STLC_Ty_Ctrs_Ctx
    (self__BaseComp: BaseComp_STLC_Ctx).
  Include BaseComp_STLC_Ty_Ctx (self__BaseComp).
  Include BaseComp_STLC_Ty (self__BaseComp).
End BaseComp_STLC_Ty_Ctrs_Ctx.

Module Type BaseComp_STLC_Ty_Ctrs
    (self__BaseComp: BaseComp_STLC_Ctx)
    (self__STLC : BaseComp_STLC_Ty_Ctrs_Ctx self__BaseComp).
  Include STLCBase_Ty_Ctrs (self__STLC).
End BaseComp_STLC_Ty_Ctrs.
